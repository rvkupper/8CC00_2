...
def extractData(filename: str) -> tuple:
    ...
    :param filename: name of the file from which data should be extracted.
...
def extractLabels(file:str) -> dict:
    """Extract labels from csv file where names are in 2nd column and \
    labels in the 4th and return in dict.    
    """
